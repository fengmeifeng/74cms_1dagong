...
{	
	...
	$smarty->display('set_px/admin_set_config.htm');
}
...
elseif($act == 'map')
{
	...
	$smarty->display('set_px/admin_set_map.htm');
}
elseif($act == 'agreement')
{
	...
	$smarty->display('set_px/admin_set_agreement.htm');
}
elseif($act == 'set_save')
{
	check_token();
...
elseif($act == 'search')
{
	...
	$smarty->assign('config',$_CFG);
	$smarty->display('set_px/admin_set_search.htm');
}
