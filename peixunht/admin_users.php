...
if($act == 'list')
{
	...
	$smarty->display('users_zp/admin_users_list.htm');
}
elseif($act == 'add_users')
{
	...
	$smarty->display('users_zp/admin_users_add.htm');
}
...
elseif($act == 'edit_users')
{
	...
	$smarty->assign('admin_purview',$_SESSION['admin_purview']);
	$smarty->display('users_zp/admin_users_edit.htm');
	}
	else
	{
	adminmsg("参数错误！",1);
...
elseif($act == 'edit_users_pwd')
{
	...
	$smarty->assign('account',$account);
	$smarty->assign('admin_purview',$_SESSION['admin_purview']);
	$smarty->display('users_zp/admin_users_edit_pwd.htm');
	}
	else
	{
	adminmsg("参数错误！",1);
...
elseif($act == 'loglist')
{
	...
	$smarty->display('users_zp/admin_users_log.htm');
}
elseif($act == 'users_set')
{
	...
	$smarty->display('users_zp/admin_users_set.htm');
}
