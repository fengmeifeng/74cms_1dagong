		...
		function selid($id){
			...
			foreach ($data as $i=>$v){
				...
				//报单员菜单
					...
					//----------------------------------------
					if($DEPT_ID!='2' && $DEPT_ID!='23' && $DEPT_ID!='24' && $DEPT_ID!='26' && $DEPT_ID!='27' && $DEPT_ID!='39' && $DEPT_ID!='28' && $DEPT_ID!='41' && $DEPT_ID!='42'){
						if($DEPT_PARENT==0){
							$icoz=",iconClose:'".$GLOBALS['res']."ico/".$v['ico']."'";
							$ico="iconOpen:'".$GLOBALS['res']."ico/".$v['ico']."'".$icoz;
						}else{
				...
				//审核员菜单
					...
					if($_SESSION['user']=='000001'){
						...
						if($DEPT_ID!='2' && $DEPT_ID!='36' && $DEPT_ID!='37' && $DEPT_ID!='41' && $DEPT_ID!='42'){
							if($DEPT_PARENT==0){
								$icoz=",iconClose:'".$GLOBALS['res']."ico/".$v['ico']."'";
								$ico="iconOpen:'".$GLOBALS['res']."ico/".$v['ico']."'".$icoz;
							}else{
				...
				//财务菜单
					...
					//----------------------------------------
					if($DEPT_ID!='2' && $DEPT_ID!='22' && $DEPT_ID!='29' && $DEPT_ID!='33' && $DEPT_ID!='36' && $DEPT_ID!='41' && $DEPT_ID!='42'){
						if($DEPT_PARENT==0){
							$icoz=",iconClose:'".$GLOBALS['res']."ico/".$v['ico']."'";
							$ico="iconOpen:'".$GLOBALS['res']."ico/".$v['ico']."'".$icoz;
						}else{
