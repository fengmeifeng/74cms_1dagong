			...
			switch($_SESSION['priv']){
				case $_SESSION['priv']==2 || $_SESSION['priv']==4:
					...
					if(!empty($_GET['search']) && $_GET['findvalue']!=''){
						$where_sql=" jihuo='1' and status!='0' and add_gs='".$_SESSION['user']."' and ".$_GET['search']." like '%".$_GET['findvalue']."%' ";
					}else{
						$where_sql=" jihuo='1' and status!='0' and add_gs='".$_SESSION['user']."' ";
					}
					break;
				case 1:
					if(!empty($_GET['search']) && $_GET['findvalue']!=''){
						$where_sql=" jihuo='1' and status!='0' and add_gs!='' and ".$_GET['search']." like '%".$_GET['findvalue']."%' ";
					}else{
						$where_sql=" jihuo='1' and status!='0' and add_gs!='' ";
					}
					break;
				default:	//默认无
					exit('没权访问！');
			...
			switch($_SESSION['priv']){
				case $_SESSION['priv']==2 || $_SESSION['priv']==3 || $_SESSION['priv']==4:
					...
					if(!empty($_GET['search'])){
						$where_sql=" jihuo='0' and hujiaozhongxin!='1' and status!='0' add_gs='".$_SESSION['user']."' and ".$_GET['search']." like '%".$_GET['findvalue']."%' ";
					}else{
						$where_sql=" jihuo='0' and hujiaozhongxin!='1' and status!='0' add_gs='".$_SESSION['user']."'";
					}
					break;
				case 1:
					if(!empty($_GET['search'])){
