<?php /* Smarty version 2.6.18, created on 2015-10-20 16:56:07
         compiled from add_gs_user/add_gs_jihuiuser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'add_gs_user/add_gs_jihuiuser.tpl', 121, false),)), $this); ?>
...
/add_gs_jihuiuser" method="get" style="display:inline;">
			...
			<input type="button" value=" 导出 " class="sub" onclick="location='<?php echo $this->_tpl_vars['app']; ?>
/user/daochuexcel?<?php echo $this->_tpl_vars['changshu']; ?>
';">
		</form>
	</td>
</tr>
...
/add_gs_jihuiuser/paixu/jiangjin/fs/<?php echo $this->_tpl_vars['fs']; ?>
...
"> <?php echo $this->_tpl_vars['item']['ruzhi_name']; ?>
	...
	<td noWrap  align='center'> <a href="<?php echo $this->_tpl_vars['app']; ?>
/user/huiyuaninfo/id/<?php echo $this->_tpl_vars['item']['id']; ?>
/dqurl/jihuiuser">查资料</a> <a href="<?php echo $this->_tpl_vars['app']; ?>
/user/huiyuantuijian/id/<?php echo $this->_tpl_vars['item']['id']; ?>
 "> 推荐列表</a>  
