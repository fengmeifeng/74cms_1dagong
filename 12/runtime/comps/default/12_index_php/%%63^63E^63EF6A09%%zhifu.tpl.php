<?php /* Smarty version 2.6.18, created on 2015-10-20 16:56:18
         compiled from tixian/zhifu.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'tixian/zhifu.tpl', 68, false),)), $this); ?>
...
/zhifu" method="get" style="display:inline;">
...
元 </td>
	<td noWrap  align='left'> <?php echo $this->_tpl_vars['item']['txmoney']; ?>
元 </td>
...
<?php echo $this->_tpl_vars['item']['subbranch']; ?>
	...
	<?php if ($this->_tpl_vars['item']['fafangzhangtai'] != '2'): ?><a href="<?php echo $this->_tpl_vars['url']; ?>
/fafangjiangjin/id/<?php echo $this->_tpl_vars['item']['id']; ?>
/zhangtai/cg" onclick="return confirm('你确定要支付成功吗? ')">支付成功</a><?php endif; ?> &nbsp;&nbsp; 
	<a href="<?php echo $this->_tpl_vars['url']; ?>
/fafangjiangjin/id/<?php echo $this->_tpl_vars['item']['id']; ?>
/zhangtai/sb" onclick="return confirm('你确定要支付失败吗? ')">支付失败</a>  </td>
</tr>
