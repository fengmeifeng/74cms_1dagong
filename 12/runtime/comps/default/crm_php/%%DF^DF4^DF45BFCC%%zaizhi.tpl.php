<?php /* Smarty version 2.6.18, created on 2014-09-01 20:46:15
         compiled from huiyuan/zaizhi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'huiyuan/zaizhi.tpl', 106, false),)), $this); ?>
...
/zaizhi" method="get" style="display:inline;">
...
<tr>
	<td colspan="21" class="biaoti" align="left">&nbsp;在职会员</span></td>
</tr>
<tr class="biaoti">
	...
	<td noWrap width="35">关系</td>
	<td noWrap width="35">性别</td>
	<td noWrap width="50">手机号</td>
	<td noWrap width="45">QQ</td>
	<td noWrap width="70">地址</td>
    <td nowrap width="50">添加时间</td>
	<td nowrap width="85">入职状态和时间</td>
	<td nowrap width="60">入职企业</td>
	<td nowrap width="85">激活状态和时间</td>
...
/images/6710a.gif" title="跟踪记录" border="0"></a>
 ...
 <?php endif; ?> </td>
	...
	<td noWrap  align='center'> <?php if ($this->_tpl_vars['item']['status'] == '1'): ?> <font color="green">已入职</font> <?php else: ?> <font color="red">未入职</font> <?php endif; ?>		<?php if ($this->_tpl_vars['item']['ruzhi_time'] != '0'): ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['ruzhi_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
 <?php endif; ?> </td>
