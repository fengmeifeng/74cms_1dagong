...
/index/xiaoxi", function(data){
			if(data!=1){
				jQuery(window.parent.parent.frames["main"].document).find(".tx_box").remove();;
				jQuery(window.parent.parent.frames["main"].document.body).append(data);
			}
		 });
	}
</script>
...
</span> [<?php echo $this->_tpl_vars['priv_name']; ?>
] 
		</div>
		<div class="caidan">
		</div>
