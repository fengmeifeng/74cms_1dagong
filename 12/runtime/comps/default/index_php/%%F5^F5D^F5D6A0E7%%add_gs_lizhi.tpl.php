<?php /* Smarty version 2.6.18, created on 2014-09-01 17:47:31
         compiled from add_gs_user/add_gs_lizhi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'add_gs_user/add_gs_lizhi.tpl', 95, false),)), $this); ?>
...
/add_gs_lizhi" method="get" style="display:inline;">
...
<tr class="khbox tab" >
 ...
 <?php endif; ?> </td>
	...
	<td noWrap  align='left'> <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['lizhi_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
 </td>
