<?php /* Smarty version 2.6.18, created on 2014-09-16 14:22:51
         compiled from user/weijihuouser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'user/weijihuouser.tpl', 117, false),)), $this); ?>
...
/weijihuouser" method="get" style="display:inline;">
...
天 </td>
	...
	<?php else: ?>
		<?php if ($this->_tpl_vars['priv'] == '1' && $this->_tpl_vars['priv'] == '4'): ?> <a href="javascript:alert('没有权限!')"> 激活会员 </a> <?php else: ?><a onclick="return confirm('你确定要激活吗? ')" href="<?php echo $this->_tpl_vars['url']; ?>
/jihuohuiyuan/id/<?php echo $this->_tpl_vars['item']['id']; ?>
"> 激活会员</a><?php endif; ?> <a href="<?php echo $this->_tpl_vars['url']; ?>
/huiyuaninfo/id/<?php echo $this->_tpl_vars['item']['id']; ?>
/dqurl/weijihuouser">查资料</a> 
	<?php endif; ?>
	<?php if ($this->_tpl_vars['item']['add_gs'] != '' && $this->_tpl_vars['item']['add_gs'] != $this->_tpl_vars['gdd_user'] && $this->_tpl_vars['gdd_user'] != 'admin'): ?>
		<a href="javascript:;" onclick="alert('没有权限！')" >无法操作</a>
	<?php else: ?>
