...
<tr>
	<td colspan="21" align="left">
		&nbsp;查找：<form action="<{$url}>/add_gs_weijihuouser" method="get" style="display:inline;">
...
<tr class="khbox tab" >
    ...
    <td> <{if $priv=='1' and $priv=='4'}> <a href="javascript:alert('没有权限!')"> 激活会员 </a> <{else}><a onclick="return confirm('你确定要激活吗? ')" href="<{$app}>/user/jihuohuiyuan/id/<{$item.id}>"> 激活会员</a><{/if}> <a href="<{$app}>/user/huiyuaninfo/id/<{$item.id}>/dqurl/weijihuouser">查资料</a>  <{if $item.status=='1'}>
