...
<div class="regwrap">
	<form name="form1" method="post" action="<{$url}>/zhucetuijian">
		<input type="hidden" name="tuijianbiaohao" value="<{$tuijianbianhao}>" />
		
		<h3>注册用户：</h3>
		<br/>	
		<ul class="">
			<li><label>和推荐人的关系：</label><select class="ipt" name="guanxi" style="height: 28px;">
			...
			<li><label>手机号：</label>
			<input class="ipt" type="text" name="sphone" size="20" maxlength="13" > <span class="red">*</span></li>
			<li><label>QQ/微信号：</label><input class="ipt" type="text" name="qq" size="20" maxlength="13" >
			<li><label>身份证号码：</label>
			<input class="ipt" type="text" name="id_number" size="26" maxlength="19" > <span class="red">*</span></li>
		</ul>
		<br/>
		<ul class="">
