...
<script type="text/javascript">
    ...
    function yijiao(){
		...
		postForm.action = '<{$url}>/fenpeiuser' ; 
...
<tr>
	<td colspan="21" align="left">
		&nbsp;查找：<form action="<{$url}>/weifenpei" method="get" style="display:inline;">
...
<tr class="khbox tab" onDblClick="location.href='#'">
	<td noWrap  align='left'> 
		...
		<a href="<{$url}>/fenpeiuser/id/<{$item.id}>/name/<{$item.name}>"><img src="<{$res}>/ico/6710.gif" title="分配" border="0"></a>
	</td>
