...
echo "<font color='red'>QS:qs_jobs数据到qs_jobs_search_stickrtime的克隆(涉及字段：id、uid)</font><br/><br/>";
//新增字段 
...
foreach($row1 as $v){
		...
		$query2="insert into qs_jobs_search_stickrtime(id,uid,sex,nature,subclass,district,education,experience,wage,refreshtime)
