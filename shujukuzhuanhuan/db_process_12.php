...
echo "<font color='red'>QS:qs_jobs数据到qs_jobs_search_hot的克隆(解决按点击次数|热度 搜索不出结果的问题)</font><br/><br/>";
//新增字段 
...
$query1="select a.id,a.uid,a.sex,a.nature,a.topclass,a.category,a.subclass,a.district,a.sdistrict,a.click,a.education,a.experience,a.wage,a.refreshtime from qs_jobs a";
...
foreach($row1 as $v){
		...
		$query2="insert into qs_jobs_search_hot(id,uid,sex,nature,subclass,district,sdistrict,education,experience,wage,click,refreshtime)
		values(".$v[0]['id'].",".$v[0]['uid'].",".$v[0]['sex'].",".$v[0]['nature'].",".$v[0]['topclass'].",".$v[0]['category'].",".$v[0]['subclass'].",".$v[0]['district']."
		,".$v[0]['sdistrict'].",".$v[0]['education'].",".$v[0]['experience'].",".$v[0]['wage'].",".$v[0]['click'].",".$v[0]['refreshtime'].")";	
		// echo $query2."<br>";exit;
