...
if (!empty($jobshow))
{
	...
	if (!empty($mapuid))
	{
		...
		$js.="$.get('{$_CFG['website_dir']}plus/ajax_common.php?uid={$row['uid']}', {'act':'joblisttip'},function (data,textStatus){infoWindow{$row['id']}.setContent(htm+data+htmend)});";
		$js.="}";	
		$js.="});";
	...
	$js.="$.getScript('{$_CFG['website_dir']}plus/ajax_map.php?jobshow={$jobshow}&pagenav=no&page='+page_id*{$perpage});";
    $js.="}";
...
if ($id==1)
{
	...
	$js.="$('.maploading').hide();";
	$js.="$.getScript(\"{$_CFG['website_dir']}plus/ajax_map.php?jobshow=point:::\"+sw.lng+\",\"+ne.lng+\",\"+sw.lat+\",\"+ne.lat);";
...
elseif ($id==2)
{
	...
	$js.="$('.listloading').show().css('opacity',0.8);";
	$js.="$.getScript(\"{$_CFG['website_dir']}plus/ajax_map.php?jobshow=jobcategory:::\"+jobcategory);";
	$js.="}";
	$js.="});";
	exit(iconv_js($js));
}
elseif ($id==3)
{
	...
	$js.="$(\"#infolist\").html('<li class=\"noinfo\">载入中...</li>');";
	$js.="$('.listloading').show().css('opacity',0.8);";
	$js.="$.getScript(\"{$_CFG['website_dir']}plus/ajax_map.php?jobshow=citycategory:::\"+citycategory);";
	$js.="}";
	$js.="});";
	exit(iconv_js($js));
}
elseif ($id==4)
{
	...
	$js.="$(\"#infolist\").html('<li class=\"noinfo\">载入中...</li>');";
	$js.="$('.listloading').show().css('opacity',0.8);";
	$js.="$.getScript(\"{$_CFG['website_dir']}plus/ajax_map.php?jobshow=trade:::\"+trade);";
	$js.="}";
	$js.="});";
	exit(iconv_js($js));
}
elseif ($id==5)
{
	...
	$js.="$(\"#infolist\").html('<li class=\"noinfo\">载入中...</li>');";
	$js.="$('.listloading').show().css('opacity',0.8);";
	$js.="$.getScript(\"{$_CFG['website_dir']}plus/ajax_map.php?jobshow=key:::\"+key);";
	$js.="}";
	$js.="});";
	exit(iconv_js($js));
}
elseif ($id==6)
{
	...
	$js.="$(\"#infolist\").html('<li class=\"noinfo\">载入中...</li>');";
	$js.="$('.listloading').show().css('opacity',0.8);";
	$js.="$.getScript(\"{$_CFG['website_dir']}plus/ajax_map.php?jobshow=new:::1\");";
	exit(iconv_js($js));
}
?>