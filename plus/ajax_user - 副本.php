...
elseif ($act=='do_reg')
{
	...
	//------销售经理
	$xs_user = isset($_POST['xs_user'])?trim($_POST['xs_user']):exit("err");
	...
	$register=user_register($username,$password,$member_type,$email,true,$xs_user,$district_cn,$district,$sdistrict,$sex,$sex_cn,$realname,$birthday,$residence,$residence_cn);
	if ($register>0)
	{	
