...
elseif($act == 'add_jobs')
{
	...
	$smarty->assign('user',$user);
			...
			$smarty->assign('title','更新版本 - 管理中心 - '.$_CFG['site_name']);
...
elseif ($act=='addjobs_save')
{
	...
	//$setsqlarr['v_id']=!empty($_POST['v_id'])?intval($_POST['v_id']):adminmsg('您没有填写版本号！',1);
	//$setsqlarr['msg']=!empty($_POST['msg'])?trim($_POST['msg']):adminmsg('您没有填写版本说明',1);
	...
	$_FILES['apk_url']['name']?adminmsg('请上传文件！',1):"";
