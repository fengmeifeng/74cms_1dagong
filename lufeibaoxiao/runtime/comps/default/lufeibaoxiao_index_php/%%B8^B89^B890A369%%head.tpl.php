...
/css/img/head-bg.jpg) top right no-repeat;">
		<div id="welcome">
			欢迎您，<span><?php echo $this->_tpl_vars['user']['dqname']; ?>
</span> [<?php echo $this->_tpl_vars['user']['qx_name']; ?>
]
		</div>
		<div class="caidan">
...
/css/img/back.gif" align="absmiddle"></a>&nbsp;
			<a href="javascript:history.forward();" ><img src="<?php echo $this->_tpl_vars['res']; ?>
/css/img/forward.gif" align="absmiddle"></a>
		</div>
