<?php require_once('D:\fengmf\wwwroot\74cms_1dagong\include\template_lite\plugins\modifier.default.php'); $this->register_modifier("default", "tpl_modifier_default",false);  require_once('D:\fengmf\wwwroot\74cms_1dagong\include\template_lite\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format",false);  require_once('D:\fengmf\wwwroot\74cms_1dagong\include\template_lite\plugins\modifier.cat.php'); $this->register_modifier("cat", "tpl_modifier_cat",false);  require_once('D:\fengmf\wwwroot\74cms_1dagong\include\template_lite\plugins\modifier.qishi_parse_url.php'); $this->register_modifier("qishi_parse_url", "tpl_modifier_qishi_parse_url",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2018-07-09 15:18 中国标准时间 */  $_templatelite_tpl_vars = $this->_vars;
...
" <?php if ($_GET['settr'] == "30"): ?>class="select"<?php endif; ?>>一月内</a>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan">
    <tr>
      ...
      <td align="center" width="8%"  class="admin_list_tit">到期时间</td>
      <td align="center" width="8%"  class="admin_list_tit">刷新时间</td>
	    <td align="center" width="4%" class="admin_list_tit">点击</td>
	    <td align="center" width="9%" class="admin_list_tit">收到简历</td>
...
"><?php echo $this->_vars['list']['companyname']; ?>
       ...
       <td class="admin_list" align="center" >
		...
		<?php echo $this->_vars['list']['click']; ?>
		  ...
		  <td class="admin_list" align="center" >
		<?php echo $this->_vars['list']['get_resume']; ?>
