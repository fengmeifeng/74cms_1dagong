<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2018-07-09 15:18 中国标准时间 */  $_templatelite_tpl_vars = $this->_vars;
...
<input type="radio" name="closereg" value="1"  <?php if ($this->_vars['config']['closereg'] == "1"): ?>checked=checked<?php endif; ?>/>是</label></td>
	...
	<tr>
      <td align="right">关闭更新时间：</td>
      <td>
	  <label>
        <input name="closetime" type="radio" id="closetime" value="0"  <?php if ($this->_vars['config']['closetime'] == 0): ?>checked=checked <?php endif; ?>/>否</label>
&nbsp;&nbsp;&nbsp;&nbsp;
<label >
<input type="radio" name="closetime" value="1"  <?php if ($this->_vars['config']['closetime'] == "1"): ?>checked=checked<?php endif; ?>/>是</label></td>
    </tr>
