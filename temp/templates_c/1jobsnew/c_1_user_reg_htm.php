<?php require_once('D:\fengmf\wwwroot\74cms_1dagong\include\template_lite\plugins\modifier.default.php'); $this->register_modifier("default", "tpl_modifier_default",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2018-09-28 15:00 中国标准时间 */ ?>
...
","time":new Date().getTime(),"act":"send_code"},							
						...
						<div class="form-group">
							...
							<div class="fl">
								<div style="z-index:10; float:left">
                                 <div class="input_text_wc0_bg date_input"><?php if ($this->_vars['userprofile']['birthday']):  echo $this->_vars['userprofile']['birthday'];  else: ?>请选择<?php endif; ?></div>
						...
						<div class="form-group idng" id="jobsCity_1" style="position:relative;z-index:9">
							...
							<div class="fl" style="width:220px;">
                                ...
                                <div class="input_text_wc0_bg" id="cityText_1"><?php echo $this->_run_modifier($this->_vars['userprofile']['residence_cn'], 'default', 'plugin', 1, "请选择"); ?>
</div>
