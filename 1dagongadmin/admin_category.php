...
elseif($act == 'add_sandistrict')
{
	...
	$smarty->display('category/admin_category_sandistrict_add.htm');
}
//修改界面
elseif($act == 'edit_sandistrict')
{
	...
	$smarty->display('category/admin_category_sandistrict_edit.htm');
}
//三级分类入库
...
elseif($act == 'train')
{
	...
	//var_dump(get_category_jobs());exit;
	$smarty->display('category/admin_category_train.htm');
}
...
elseif($act == 'edit_train_category')
{
	...
	$smarty->display('category/admin_category_train_edit.htm');
}
elseif($act == 'edit_jobs_category_save')
{
	check_token();
...
elseif($act == 'add_category_train')
{
	get_token();
	$smarty->assign('navlabel',"train");
	$smarty->display('category/admin_category_train_add.htm');
}
