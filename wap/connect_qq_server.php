...
$login_allback="{$_CFG['main_domain']}wap/connect_qq_server.php?act=login_allback" ;
$binding_callback="{$_CFG['main_domain']}wap/connect_qq_server.php?act=binding_callback" ;
