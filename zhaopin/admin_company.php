...
if($act == 'jobs')
{
	...
	get_token();
	$smarty->display('company_zp/admin_company_jobs.htm');
}
...
elseif($act == 'edit_jobs')
{
	...
	$smarty->display('company_zp/admin_company_jobs_edit.htm');
}
...
elseif($act == 'company_list')
{
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_company_list.htm');
}
...
elseif($act == 'edit_company_profile')
{
	...
	$smarty->display('company_zp/admin_company_profile_edit.htm');
}
...
{	
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_order_list.htm');
}
elseif($act == 'show_order')
{
	...
	$smarty->display('company_zp/admin_order_show.htm');
}
...
elseif($act == 'order_set')
{
	...
	$smarty->assign('url',$_SERVER["HTTP_REFERER"]);
	$smarty->assign('payment',get_order_one($_GET['id']));
	$smarty->display('company_zp/admin_order_set.htm');
}
...
elseif($act == 'meal_members')
{
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_company_meal_members.htm');
}
elseif($act == 'meal_log')
{
	get_token();
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_company_meal_log.htm');
}
elseif($act == 'meal_log_pie')
{
	...
	$smarty->display('company_zp/admin_company_meal_log_pie.htm');
}
...
elseif($act == 'members_list')
{
	...
	$smarty->assign('member',$member);
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_company_user_list.htm');
}
...
elseif($act == 'members_add')
{
	...
	$smarty->display('company_zp/admin_company_user_add.htm');
}
...
{	
	...
	$smarty->display('company_zp/admin_consultant_install.htm');
}
//保存  设置顾问
...
elseif($act == 'user_edit')
{
	...
	$smarty->assign('givesetmeal',get_setmeal(false));
	$smarty->assign('url',$_SERVER["HTTP_REFERER"]);
	$smarty->display('company_zp/admin_company_user_edit.htm');
}
...
elseif($act == 'comment_list')
{
	...
	$smarty->assign('clist',$clist);
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_comment_list.htm');
}
...
elseif($act == 'company_img')
{
	...
	$smarty->assign('clist',$clist);
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_company_img.htm');
}
...
elseif($act == 'company_news')
{
	...
	$smarty->assign('clist',$clist);
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_company_news.htm');
}
...
elseif($act == 'edit_company_news')
{
	...
	$smarty->assign('url',$_SERVER["HTTP_REFERER"]);
	$smarty->assign('pageheader',"企业新闻");
	$smarty->display('company_zp/admin_company_news_edit.htm');
}
...
elseif($act == 'consultant')
{
	...
	$smarty->assign('clist',$clist);
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_consultant_list.htm');
}
//顾问  管理
elseif($act == 'consultant_manage')
{
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('company_zp/admin_consultant_manage.htm');
}
//管理 顾问  重置 按钮 
...
elseif($act == 'consultant_add')
{
	...
	$smarty->assign('pageheader',"顾问管理");
	$smarty->display('company_zp/admin_consultant_add.htm');
}
...
elseif($act == 'consultant_edit')
{
	...
	$smarty->assign('consultant',$consultant);
	$smarty->assign('pageheader',"顾问管理");
	$smarty->display('company_zp/admin_consultant_edit.htm');
}
