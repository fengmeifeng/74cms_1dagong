...
if($act == 'list')
{
	...
	$smarty->display('personal_zp/admin_personal_resume.htm');
}
elseif($act == 'perform')
{
		check_token();
...
elseif($act == 'members_list')
{
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('personal_zp/admin_personal_user_list.htm');
}
...
{	
	...
	$smarty->display('personal_zp/admin_personal_user_edit.htm');
}
...
elseif($act == 'members_add')
{
	...
	$smarty->assign('pageheader',"个人会员");
	$smarty->display('personal_zp/admin_personal_user_add.htm');
}
...
elseif($act == 'resume_show')
{
	...
	$smarty->display('personal_zp/admin_personal_resume_show.htm');
}
