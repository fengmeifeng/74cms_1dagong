...
```
### 我的简历——个人简历基本信息获取(完成FMF)
**接口地址** 
`GET`   `/interface/resume_base_info_ios.php`
> eg.     http://www.1dagong.com/interface/resume_base_info_ios.php
...
```javascript
{
	...
	data:
		...
		｝	
``` 	
### 全职工作——职位详情——职位信息(完成 FMF)
**接口地址** 
`GET`   `/interface/quanzhi_detail_ios.php`
> eg.     http://www.1dagong.com/interface/quanzhi_detail_ios.php`
...
```
### 全职工作——职位详情——公司信息(完成 FMF)
**接口地址** 
`GET`   `/interface/quanzhi_detail_company_ios.php`
> eg.     http://www.1dagong.com/interface/quanzhi_detail_company_ios.php`
...
```
### 兼职工作——职位详情——职位信息(完成FMF)
**接口地址** 
`GET`   `/interface/jianzhi_detail_ios.php`
> eg.     http://www.1dagong.com/interface/jianzhi_detail_ios.php
...
```
### 兼职工作——职位详情——公司信息(完成 FMF)
**接口地址** 
`GET`   `/interface/jianzhi_detail_company_ios.php`
> eg.     http://www.1dagong.com/interface/jianzhi_detail_company_ios.php
