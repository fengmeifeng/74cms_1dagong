...
//获取教育经历列表
//获取：工作经历
function get_resume_work($uid,$pid,$limit)
{
	global $db;
	$sql = "select * from ".table('resume_work')." where pid='".$pid."' AND uid=".intval($uid)."".$limit ;
...
$db = new mysql($dbhost,$dbuser,$dbpass,$dbname);
	...
	$list=get_resume_work($userid,$resume_id,$limit);
