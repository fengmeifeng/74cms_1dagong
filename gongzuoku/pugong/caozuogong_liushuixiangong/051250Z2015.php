...
<html lang="zh-cn">
	...
	<meta name="description" content="1、负责本车间设备巡检、维护以及设备润滑，确保本系统的设备运行正常； 2、严格执行 公司 的规章制度、安全操作规程，确保本系统无安全事故发生； 3、负责提出本岗位的安全隐患" />
	<title>焚烧巡检技术员_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5090&job=39208&c=重庆天志环保有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、负责本车间设备巡检、维护以及设备润滑，确保本系统的设备运行正常；<br /> 2、严格执行<a href=\"http://www.hrm.cn/chongqing/jobs/53994/\" target=\"_blank\">公司</a>的规章制度、安全操作规程，确保本系统无安全事故发生；<br /> 3、负责提出本岗位的安全隐患和自己的处理办法，并提请焚烧主控协调相关部门解决；<br /> 4、按时、认真如实填写岗位巡检记录，确保记录真实、可靠，字迹工整、清晰；<br /> 5、负责向焚烧转运工传达焚烧主控当日的<a href=\"http://www.hrm.cn/\" target=\"_blank\">工作</a>安排，同时负责安排、监督转运<a href=\"http://www.hrm.cn/chongqing/jobs/53993/\" target=\"_blank\">人员</a>现场临时工作；<br /> 6、负责协助主控操作焚烧各设备；<br /> 7、负责协助<a href=\"http://www.hrm.cn/chongqing/jobs/40075/\" target=\"_blank\">维修</a>人员现场维修工作；<br /> 8、完成上级领导交办的其它工作。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5090&job=39208&c=重庆天志环保有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=5090'>焚烧巡检技术员</a></dt>
					<dd>1、负责本车间设备巡检、维护以及设备润滑，确保本系统的设备运行正常； ...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=5090">我想去</a></u></dd>
