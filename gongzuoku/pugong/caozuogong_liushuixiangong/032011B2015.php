...
<html lang="zh-cn">
	...
	<title>操作工/业务跟单_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>合肥顺达精密钢管有限公司</li>
                        <li ><span>地区：</span>安徽省 - 合肥市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>不限</li>
                        <li ><span>学历要求：</span>不限</li>
                        <li ><span>招聘人数：</span>80</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-20</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1166&job=20995&c=合肥顺达精密钢管有限公司"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1166&job=20995&c=合肥顺达精密钢管有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=1155'></a></dt>
					<dd>入职当月即买缴纳五险一金,非中介机构，公司直招...</dd>
					<dd class="bb">已有<b></b>人报名<u><a href="/plus/view.php?aid=1155">我想去</a></u></dd>
