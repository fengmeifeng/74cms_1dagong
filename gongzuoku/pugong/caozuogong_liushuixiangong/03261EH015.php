...
<html lang="zh-cn">
	...
	<title>电焊工2名；普通冲床2名；数控冲床2名；组装工_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>电焊工2名；普通冲床2名；数控冲床2名；组装工</h1>
                </div>
                <div class="h1_box">发布时间： 2015年03月26日</div>
                <div class="over">
                    <ul class="a_box">
                        <li ><span>工资：</span><strong>面议</strong></font><span></span></li>
                        <li ><span>公司：</span><a href="/home/index.php?uid=21274&action=archives&channelid=81">安徽鹏翔电气科技</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1697&job=21274&c=安徽鹏翔电气科技"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、学徒工2000元左右，包食宿，学会即提升工资报酬，有升职空间；
           ...
           4、员工食宿费全免；
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1697&job=21274&c=安徽鹏翔电气科技" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
