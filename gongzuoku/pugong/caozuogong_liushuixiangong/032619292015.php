...
<html lang="zh-cn">
	...
	<title>操作工、焊工、质检员、工艺员_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>操作工、焊工、质检员、工艺员</h1>
                </div>
                <div class="h1_box">发布时间： 2015年03月26日</div>
                <div class="over">
                    <ul class="a_box">
                        <li ><span>工资：</span><strong>面议</strong></font><span></span></li>
                        <li ><span>公司：</span><a href="/home/index.php?uid=23824&action=archives&channelid=81">合肥市智德工贸有限责任公司</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1929&job=23824&c=合肥市智德工贸有限责任公司"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <dl>
                        本公司因业务量增加，需招聘以下员工：
1、操作工若干名，计件工资；
2、气保焊工10名，转正后计件3000-4500/月；
3、设备维修工若干名，工资面议；
4、质检员3名，工资面议；
5、工艺员1名，工资面议。
公司提供食宿，住宿条件：四人间独卫带空调公寓。
     
任职资格：
1、操作工：从事过冲压工作者优先；
2、焊工：二氧化碳气体保护焊、电阻电焊、紧固件凸焊，有相关工作经验。
3、维修工：对生产设备进行日常维护，能独立维修冲床和油压机。
4、质检员：有钣金制造业、汽行零部件生产行业相关工作经验者优先。
5、工艺员：负责新品工艺试制，以及技术的监督执行。
工作地点：经开区紫蓬路518号
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1929&job=23824&c=合肥市智德工贸有限责任公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
