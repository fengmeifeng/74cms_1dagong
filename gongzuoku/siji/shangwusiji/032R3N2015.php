	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=2378&job=21560&c=上海吉祥建材集团有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1.男，有叉车证，25-40岁，身体健康，能吃苦耐劳。
...
按规定正式录用后参加社保。
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=2378&job=21560&c=上海吉祥建材集团有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
