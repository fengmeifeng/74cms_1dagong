...
<html lang="zh-cn">
	...
	<title>庆典礼仪/客服专业/销售_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
...
<div class="container">
    <ol class="breadcrumb "><!--mt_20-->
		<li class="active"><a href='http://www.1dagong.com'>网站首页</a> / <a href='/plus/list.php?tid=41'>工作库</a> / <a href='/plus/list.php?tid=46'>服务员</a> / <a href='/plus/list.php?tid=77'>迎宾/接待</a> / </li>
		<li>庆典礼仪/客服专业/销售</li>
    </ol>
</div>
...
<div class="container">
	<div class="row">
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>合肥合广广告传媒有限公司</li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1291&job=21393&c=合肥合广广告传媒有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        负责指定区域的市场开发、客户维护和销售管理等工作/负责所属区域的产品宣传、推广和销售，完成销售的任务指标/制定自己的销售计划，并按计划拜访客户和开发新客户/根据每个客户的不通需求，制定不同的方案，促成一单的完成
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1291&job=21393&c=合肥合广广告传媒有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=1291'>庆典礼仪/客服专业/销售</a></dt>
					<dd>负责指定区域的市场开发、客户维护和销售管理等工作/负责所属区域的产品宣...</dd>
					<dd class="bb">已有<b></b>人报名<u><a href="/plus/view.php?aid=1291">我想去</a></u></dd>
