...
<html lang="zh-cn">
	...
	<title>厨工/保洁员_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
...
<div class="container">
    <ol class="breadcrumb "><!--mt_20-->
		<li class="active"><a href='http://www.1dagong.com'>网站首页</a> / <a href='/plus/list.php?tid=41'>工作库</a> / <a href='/plus/list.php?tid=46'>服务员</a> / <a href='/plus/list.php?tid=71'>后厨</a> / </li>
		<li>厨工/保洁员</li>
    </ol>
</div>
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>招聘人数：</span>4</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-20</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1244&job=21011&c=安徽集友纸业包装有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        30-45岁，身体健康，有食堂或保洁工作经验优先
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1244&job=21011&c=安徽集友纸业包装有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
