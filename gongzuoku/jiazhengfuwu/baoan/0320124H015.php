...
<html lang="zh-cn">
	...
	<title>保安队长_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>安徽忠卫保安服务有限公司</li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1247&job=21012&c=安徽忠卫保安服务有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        任职条件： 22-40岁，身高1.73米以上，高中以上学历，（可适当放宽）。
1、有物业或保安管理同岗位工作经验。
2、有较强的处理突发事件的能力，较强的协调组织能力。
3、具备较强的沟通协调能力，能够独立开展项目点安保工作。
4、身体健康、无不良记录，有保安上岗证，消防及特种兵，在部队带过兵或退伍军人优先。
5、若自管项目区域保安员缺少应极积配合公司人事部招聘。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1247&job=21012&c=安徽忠卫保安服务有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
