...
<html lang="zh-cn">
	...
	<meta name="description" content="1、负责对入场的危废物品按照要求进行计重； 2、负责各类危废入场时与相关转移联单种类、单数据进行初步核实，发现与单据不符的上报 库管 主管处理； 3、负责及时按照库房定置管" />
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=39208&action=archives&channelid=81">重庆天志环保有限公司</a></li>
                        <li ><span>地区：</span>重庆市 - 璧山县</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>高中</li>
                        <li ><span>招聘人数：</span>2人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2015-07-12</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5089&job=39208&c=重庆天志环保有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、负责对入场的危废物品按照要求进行计重；<br /> 2、负责各类危废入场时与相关转移联单种类、单数据进行初步核实，发现与单据不符的上报<a href=\"http://www.hrm.cn/chongqing/jobs/28081/\" target=\"_blank\">库管</a>主管处理；<br /> 3、负责及时按照库房定置管理要求，对每批次入场的危废品指定合理的库位，并组织转运<a href=\"http://www.hrm.cn/chongqing/jobs/53993/\" target=\"_blank\">人员</a>按相关操作规范进行下货、堆码；<br /> 4、及时组织转运人员将需处置的危废物料发放到生产现场，进行出库，同时做好现场物料下账<a href=\"http://www.hrm.cn/\" target=\"_blank\">工作</a>；<br /> 5、负责对每日危废品物料收入和发出作好现场记录；<br /> 6、负责危废库房的日常巡查，遇到情况的及时处理、汇报，并作好记录；<br /> 7、负责每月对危废品物料的盘存工作，并将盘存数据及时交库管主管；<br /> 8、负责向转运人员传达库管主管当日的工作安排，同时负责现场临时安排转运人员的日常工作；<br /> 9、负责各库房相关标识标牌的建立、维<a href=\"http://www.hrm.cn/chongqing/jobs/57149/\" target=\"_blank\">护工</a>作。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5089&job=39208&c=重庆天志环保有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
