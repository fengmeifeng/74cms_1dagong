...
<html lang="zh-cn">
	...
	<meta name="description" content="岗位描述： 1、确保物帐一致； 2、每天跟踪好仓库所发货物的数量，及时开单入库； 3、做好与生产班组、售后的信息沟通； 4、每天做好入库日报表及生产产值统计表，以及其他入库" />
	<title>仓管_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5077&job=38018&c=芜湖盈特电器有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p class=\"MsoNormal\"> 岗位描述： </p> <p class=\"MsoNormal\"> <!--[if !supportLists]-->1、<!--[endif]-->确保物帐一致； </p> <p class=\"MsoNormal\"> 2、每天跟踪好仓库所发货物的数量，及时开单入库；<br /> 3、做好与生产班组、售后的信息沟通； </p> <p class=\"MsoNormal\"> 4、每天做好入库日报表及生产产值统计表，以及其他入库相关事宜。 </p> <p class=\"MsoNormal\"> <p class=\"MsoNormal\"> 薪酬待遇： </p> <p class=\"MsoNormal\"> <p class=\"MsoNormal\"> 1、白班，试用期1个月，综合月收入2000元； </p> <p class=\"MsoNormal\"> 2、转正：综合月收入2400-3000元。 </p> <p class=\"MsoNormal\"> 其他福利待遇： </p> <span style=\"line-height:1.5;\">1、工龄奖：入职满1年即享受工龄工资，工龄工资按照30元/年递增，150元封顶；</span> </p> <p class=\"MsoNormal\"> <span style=\"line-height:1.5;\">2、餐费补助：标准为12元/天（公司自有食堂供应，物美价廉）；</span> </p> <p class=\"MsoNormal\"> 3、住宿补助：免费提供住宿，外地员工不住宿舍的，补助50元/人/月； </p> <p class=\"MsoNormal\"> 4、交通补助：自行解决交通工具上下班员工补助2元/人/天； </p> <p class=\"MsoNormal\"> 5、保&nbsp;&nbsp;险：按国家规定购买五险（工伤、医疗、生育、失业、养老）； </p> <p class=\"MsoNormal\"> 6、节日慰问金：春节、中秋节、端午节、三八妇女节等发放节日慰问金，标准50-200元/人； </p> <p class=\"MsoNormal\"> 7、劳动保护：提供工作服（冬季、夏季各2套），免费提供各类劳动保护设施（手套、口罩等）。 </p> </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5077&job=38018&c=芜湖盈特电器有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=5077'>仓管</a></dt>
					<dd> 岗位描述：   1、确保物帐一致；   2、每天跟踪好仓库所发货物的数量，及时开...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=5077">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=4101'>采购</a></dt>
					<dd>岗位职责： 1、协助采购经理进行采购方面的工作； 2、管理采购合同及供应商...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=4101">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=3925'>仓管员</a></dt>
					<dd>1、男性，高中/中专以上学历，会ERP系统； 2、1年仓库工作经验，熟悉仓库作业...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3925">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=3639'>仓管员</a></dt>
					<dd>工作职责： 1.管理材料出入库 2.库存清点，存放和盘点 3.使用库存管理软件 4...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3639">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=3359'>仓库管理员/理货员</a></dt>
					<dd>岗位职责： &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3359">我想去</a></u></dd>
