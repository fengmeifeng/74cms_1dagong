...
<html lang="zh-cn">
	...
	<title>shenhui苹果专卖店店员_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>shenhui苹果专卖店店员</h1>
                </div>
                <div class="h1_box">发布时间： 2015年04月13日</div>
                <div class="over">
                    <ul class="a_box">
                        <li ><span>工资：</span><strong>面议</strong></font><span></span></li>
                        <li ><span>公司：</span><a href="/home/index.php?uid=30242&action=archives&channelid=81">上海神汇通信科技有限公司</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=3606&job=30242&c=上海神汇通信科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        苹果专卖店店员 工作地点：江桥万达、青浦吾悦、松江万达、漕宝、周浦万达<br /> 岗位职责：<br /> 1、负责零售店商品的日常销售与维护工作；<br /> 2、负责店面接待与咨询，了解顾客的需求并促进销售；<br /> 3、配合公司宣传与产品推广活动；<br /> 4、产品摆放、样机演示、宣传物品的发放与布置。<br /> 5、能有效的完成公司制定的销售目标，及分配的其他任务。<br /> 要求：<br /> 1.中专以上学历，语言表达流畅，五官端正、有亲和力，积极向上；<br /> 2. 有1年以上销售经验，学习能力强，适应力强，遵纪守法；<br /> 3.热爱数码产品，有激情及对新鲜事物的接受能力，对时尚焦点有敏锐的洞察力。<br /> 4. 具有良好的服务意识和销售意识及较强的团队协作精神<br />
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=3606&job=30242&c=上海神汇通信科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=3462'>销售人员</a></dt>
					<dd>暂无职位描述</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3462">我想去</a></u></dd>
