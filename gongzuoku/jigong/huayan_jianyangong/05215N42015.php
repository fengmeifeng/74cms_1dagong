...
<html lang="zh-cn">
	...
	<meta name="description" content="1、负责生产过程和产品在生产中和生产后的监视和检验； 2、负责对产品的日期、编码、产品名称、管道进行核对； 3、负责一线员工操作前的设备、各方面指标的检查； 4、完成上级交" />
	<title>现场品管_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=38644&action=archives&channelid=81">重庆馨亚油脂有限公司</a></li>
                        ...
                        <li ><span>截止时间：</span>2015-08-21</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5784&job=38644&c=重庆馨亚油脂有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、负责生产过程和产品在生产中和生产后的监视和检验；<br /> 2、负责对产品的日期、编码、产品名称、管道进行核对；<br /> 3、负责一线员工操作前的设备、各方面指标的检查；<br /> 4、完成上级交办的其他任务；<br />
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5784&job=38644&c=重庆馨亚油脂有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
