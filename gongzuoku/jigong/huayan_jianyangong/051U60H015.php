	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5607&job=41390&c=重庆永泰兴纸业有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <b>岗位职责：</b><br /> 1.负责首检和部分过程检查、制程中不良品的标识及统计； <br /> 2.负责巡检，对整个生产过程物料使用、装配操作、机器运行、环境符合性等全方位的定时检查。<br /> 3.IPQC一般是首检、巡检和抽检；是制程中巡回流动检验 <br /> <b>岗位要求：</b><br /> 1、高中以上学历,1年以上检测检验工作经验，具有相关专业知识且熟悉流程；<br /> 2、熟悉各种常规的测量工具<br /> 3、熟悉CAD图纸；<br /> 4、正直踏实、责任心强，极佳的团队工作能力。<br /> <div id=\"qb-sougou-search\"> <p> 搜索 </p> <p class=\"last-btn\"> 复制 </p>   </div>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5607&job=41390&c=重庆永泰兴纸业有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
