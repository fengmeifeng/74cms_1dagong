...
<html lang="zh-cn">
	...
	<meta name="description" content="任职资格：1、具备基本的机械识图能力； 2、会使用装配工具； 3、能简单操作车床、铣床加工者优先录取； 4、有较强的工作责任心，能吃苦耐劳，有学习及团队合作精神； 5、机械专" />
	<title>装配钳工_壹打工网-让工作来找你</title>
	<!-- head_css-->
...
<div class="container">
	<div class="row">
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=50212&action=archives&channelid=81">重庆潜九液压技术有限公司</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=6346&job=50212&c=重庆潜九液压技术有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        任职资格：1、具备基本的机械识图能力；<br /> 2、会使用装配工具；<br /> 3、能简单操作车床、铣床加工者优先录取；<br /> 4、有较强的工作责任心，能吃苦耐劳，有学习及团队合作精神；<br /> 5、机械专业条件优先者应届生亦可；
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=6346&job=50212&c=重庆潜九液压技术有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=6346'>装配钳工</a></dt>
					<dd>任职资格：1、具备基本的机械识图能力； 2、会使用装配工具； 3、能简单操作...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=6346">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=6181'>自动化装配钳工</a></dt>
					<dd> 能独立安装；有一定的自动化设备钳工技能，初中以上学历，有设备装配两年...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=6181">我想去</a></u></dd>
