...
<html lang="zh-cn">
	...
	<title>装配钳工_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1441&job=21548&c=上海普利生机电科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1.负责公司机械设备的安装调试，一年以上的装配经验。
2.有较强的识图能力，能看懂各种机械设备的装配图，限男性。
3.具备打孔，攻丝，工差配合，焊接，平磨等工艺的能力。
4.吃苦耐劳，服从安排，具备良好的沟通及团队合作能力，能适应加班的人员。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1441&job=21548&c=上海普利生机电科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
