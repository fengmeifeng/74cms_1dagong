...
<html lang="zh-cn">
	...
	<title>程序开发工程师_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
...
<div class="container">
    <ol class="breadcrumb "><!--mt_20-->
		<li class="active"><a href='http://www.1dagong.com'>网站首页</a> / <a href='/plus/list.php?tid=41'>工作库</a> / <a href='/plus/list.php?tid=45'>技工</a> / <a href='/plus/list.php?tid=69'>设备管理维护</a> / </li>
		<li>程序开发工程师</li>
    </ol>
</div>
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1094&job=20667&c=苏州易涟移动互联网信息有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、真正的热爱互联网技术，诚实守信。拥有足够的激情和团队精神！:2、精通PHP、.Net熟悉Sql2005，可以独立完成单个项目。3、精通项目开发过程，精通Web2.0架构，熟练运用div+css设计网页
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1094&job=20667&c=苏州易涟移动互联网信息有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
