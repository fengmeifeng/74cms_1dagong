        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>截止时间：</span>2016-06-04</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=6342&job=29955&c=萨曼机械（上海）有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p class=\"MsoNormal\"> 1<span>、了解客户服务需求信息，做好售后指导和服务工作；&nbsp;</span> </p> <p class=\"MsoNormal\"> 2、熟练了解公司产品，解答客户提问并落实问题；&nbsp; </p> <p class=\"MsoNormal\"> 3<span>、与相关部门紧密配合，协调沟通；</span> </p> <p class=\"MsoNormal\"> 4、维护客户关系，并开发新客户 </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=6342&job=29955&c=萨曼机械（上海）有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
