...
<html lang="zh-cn">
	...
	<title>驾驶员兼展架安装工_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>安徽优美文化传播有限公司</li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1587&job=22917&c=安徽优美文化传播有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        负责日常公务驾驶及加油站广告展架的安装、维护及保养等工作
（2）、责任心强，吃苦耐劳，因工作需要周末或者晚上有时会加班
（3）、可熟练驾驶，熟悉合肥交通路线
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1587&job=22917&c=安徽优美文化传播有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
