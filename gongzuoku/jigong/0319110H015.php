...
<html lang="zh-cn">
	...
	<title>安装工程设计及造价师_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>招聘人数：</span>数名</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2015-09-19</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1107&job=21046&c=苏州鹏成建设有限公司"> 投递简历 </a>
...
5、年薪+奖金
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1107&job=21046&c=苏州鹏成建设有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=1084'>门窗制作熟练工</a></dt>
					<dd> 要求：男性  精通铝合金门窗制作流程，具有独立制作安装能力，思维积极吃苦...</dd>
					<dd class="bb">已有<b></b>人报名<u><a href="/plus/view.php?aid=1084">我想去</a></u></dd>
