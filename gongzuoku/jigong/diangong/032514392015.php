	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1439&job=21545&c=上海保翼自动化设备有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1.中专以上学历，要求有电工证的 ，熟悉电气装配即可，有一年以上自动化设备安装，调试工作经验。
2.能看懂电路图，熟悉传感器，PLC，等仪器仪表的接线和使用，能熟练使用各种电工工具，可以独立完成控制柜安装。
3.有良好的工作态度和责任心，有良好的团队意识和交流沟通能力。
4.能适应到外地出差。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1439&job=21545&c=上海保翼自动化设备有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
