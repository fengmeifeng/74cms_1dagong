...
<html lang="zh-cn">
	...
	<title>电气工程师_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1435&job=21545&c=上海保翼自动化设备有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1.要求男性，20-50岁，电气自动化或相关专业大专以上学历，户籍不限。
2.良好的工作态度，能承受一定的工作压力，具有良好的团队精神。
3.从事过机器人项目，从事过非标自动化行业的。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1435&job=21545&c=上海保翼自动化设备有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
