...
<html lang="zh-cn">
	...
	<title>技术储备干部_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>招聘人数：</span>3</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-20</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1248&job=21017&c=安徽锦研鑫电子科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        要求： 18-35周岁，身体健康，男女不限。大专及以上学历，电子或机电专业优先。
          对电子机电行业有浓厚兴趣，具备钻研和学习精神，工作态度积极端正，有同行业一年以    上经验，具备一定管理领导能力。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1248&job=21017&c=安徽锦研鑫电子科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
