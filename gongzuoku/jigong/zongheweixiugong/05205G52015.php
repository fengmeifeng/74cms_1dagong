...
<html lang="zh-cn">
	...
	<meta name="description" content="岗位职责 1、保证苗木科技园区及苗木科技园内水电气设施设备正常运行； 2、协调设备供应商的现场整改工作；保证公共设备、设施的正常使用； 3、个人分管设施设备的巡视和保养维" />
	<title>维修工_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=42315&action=archives&channelid=81">重庆华宇园林有限公司</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5715&job=42315&c=重庆华宇园林有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p style=\"color:#666666;font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;\"> 岗位职责&nbsp; </p> <p style=\"color:#666666;font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;\"> 1、保证苗木科技园区及苗木科技园内水电气设施设备正常运行；&nbsp; </p> <p style=\"color:#666666;font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;\"> 2、协调设备供应商的现场整改工作；保证公共设备、设施的正常使用； </p> <p style=\"color:#666666;font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;\"> 3、个人分管设施设备的巡视和保养维护； </p> <p style=\"color:#666666;font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;\"> 4、检查（验收）设备的运行情况，报告运行故障和报修结果；及时处理报修。 </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5715&job=42315&c=重庆华宇园林有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
