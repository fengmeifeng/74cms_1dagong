...
<html lang="zh-cn">
	...
	<title>工程师-设备维修或网络管理 电工/电器/电玩设备_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
...
<div class="container">
    <ol class="breadcrumb "><!--mt_20-->
		...
		<li>工程师-设备维修或网络管理 电工/电器/电玩设备</li>
    </ol>
</div>
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>工程师-设备维修或网络管理 电工/电器/电玩设备</h1>
                </div>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1114&job=21071&c=大白鲸世界文化发展(大连)有限公司"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <dl>
                        [岗位职责]
1.主要负责营业期间的安全巡视，设备故障的排查处理，保证设备正常运行
2.场内设备的日常检修、养护，保证设备正常运行
 [任职要求]
1.年龄40周岁以下，身高160cm以上
2.中专以上学历，有一定专业性，懂机电维修、弱电
3.有2年以上相关工作经验者优先，从事过家电维修、游乐场大中型电玩维修、懂机电维修者优先
4.必须持有电工证
5.工作细致、有耐心、有较强责任心
                    </dl>
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1114&job=21071&c=大白鲸世界文化发展(大连)有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
