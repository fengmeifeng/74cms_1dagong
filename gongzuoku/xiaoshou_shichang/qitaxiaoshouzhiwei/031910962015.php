...
<html lang="zh-cn">
	...
	<title>美工设计师_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1096&job=20667&c=苏州易涟移动互联网信息有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、相关工作经验2-3年； :2、平面设计、美术专业毕业或受过美术设计类培训者优先考虑，思维活跃富有创意，表现能力强，能独立完成设计方案； 3、有良好的美术功底，审美能力和创意，色彩感强；熟练使用photoshop，flash，dreamweaver等网页设计制作软件，（熟练使用DIV+CSS；熟悉Javascript、HTML代码，了解网络编程者优先）；
 4、具有较强的网页设计能力和平面艺术感悟能力
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1096&job=20667&c=苏州易涟移动互联网信息有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
