...
<html lang="zh-cn">
	...
	<meta name="description" content="岗位及职责要求： 1.为人诚实、守信，遵守职业操守。 2.工作勤奋、任劳任怨。 3.熟悉EXCELL电子表格的使用。 4.有时需要出差（主要是江浙沪地区）。" />
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=3122&job=27658&c=成都强大商贸有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <span>岗位及职责要求：<br /> 1.为人诚实、守信，遵守职业操守。 2.工作勤奋、任劳任怨。 3.熟悉EXCELL电子表格的使用。 4.有时需要出差（主要是江浙沪地区）。</span>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=3122&job=27658&c=成都强大商贸有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=3029'>区域销售 底薪+提成</a></dt>
					<dd>暂无职位描述</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3029">我想去</a></u></dd>
