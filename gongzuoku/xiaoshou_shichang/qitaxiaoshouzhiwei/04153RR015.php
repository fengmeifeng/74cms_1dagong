...
<html lang="zh-cn">
	...
	<meta name="description" content="岗位职责：1、日常的行情分析和客户维护；2、负责客户的日常管理，并与其建立良好的合作关系；3、负责指导客户的投资技巧；4、及时了解金融市场的信息，并为客户提供投资建议。" />
	<title>银行渠道销售经理_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=3828&job=31460&c=丰汇通财富管理江苏有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        岗位职责： 1、日常的行情分析和客户维护； 2、负责客户的日常管理，并与其建立良好的合作关系； 3、负责指导客户的投资技巧； 4、及时了解金融市场的信息，并为客户提供投资建议。 任职资格： 1、2年以上销售经验，热爱金融事业，能很快接受新事物； 2、具有良好的沟通、协调、分析能力，开拓能力，良好的写作能力，电脑操作能力，善于与人合作； 3、为人正直、诚信，精神面貌佳，有挑战的决心、有良好的敬业精神、职业道德和个人信誉。 
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=3828&job=31460&c=丰汇通财富管理江苏有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=3318'>财务统计</a></dt>
					<dd>1.&nbsp; 中专及以上学历，财务相关专业优先； 2.&nbsp; 有财务统计等相关工作经...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3318">我想去</a></u></dd>
