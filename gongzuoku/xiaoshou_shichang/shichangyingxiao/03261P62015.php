...
<html lang="zh-cn">
	...
	<title>贷后管理_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1806&job=23646&c=安徽唐融投资信息咨询有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                         1.学历不限，年龄在20-40岁，应届毕业生均可；
  2.有良好的沟通能力；
  3.能够服从公司安排；
  4.有催讨相关工作经验者优先
                    </dl>
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1806&job=23646&c=安徽唐融投资信息咨询有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
