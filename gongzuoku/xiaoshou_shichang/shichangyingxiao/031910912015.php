        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>苏州易涟移动互联网信息有限公司</li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1091&job=20667&c=苏州易涟移动互联网信息有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、完成公司年度营销目标以及其他任务，对营销思想进行定位；2、有独立的销售渠道，具有良好的市场拓展能力；3、协调公司内外部关系，对公司市场营销战略计划的执行进行监督和控制；4、互联网市场调查与新市场机会的发现；5、新项目市场推广方案的制定；6、成熟项目的营销组织、协调和销售绩效管理；7、销售队伍的建设与培养等。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1091&job=20667&c=苏州易涟移动互联网信息有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
