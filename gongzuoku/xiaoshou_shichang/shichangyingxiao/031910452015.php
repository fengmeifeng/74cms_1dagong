...
<html lang="zh-cn">
	...
	<title>储备干部_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>截止时间：</span>2015-10-22</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1045&job=20789&c=太平人寿保险有限公司吴江支公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        有良好的人际关系，良好的语言沟通能力，待人热情，工作认真负责，有相关工作经验者优先
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1045&job=20789&c=太平人寿保险有限公司吴江支公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
