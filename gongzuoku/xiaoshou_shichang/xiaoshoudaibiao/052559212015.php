...
<html lang="zh-cn">
	...
	<title>教育咨询顾问_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5921&job=45041&c=重庆慧果教育科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p> 岗位职责： </p> <p> 1、负责校区招生工作，完成个人招生计划； </p> <p> 2、负责电话咨询，客户邀约，登记客户信息；<br /> 3、负责接待客户来访，提供专业咨询，推荐课程； </p> <p> 4、负责客户的跟踪回访，建立持续沟通、顺畅交流的渠道 ； </p> <p> 5、负责活动及试听课的组织，并进行效果分析和方案改进； </p> <p> 6、负责报名的后续服务； </p> <p> 任职资格： </p> <p> 1、20-35岁，性别不限，（已育）女性优先； </p> <p> 2、<a href=\"http://www.huibo.com/shichang/\">市场</a>营销、教育类相关专业大专以上学历； </p> <p> 3、一年以上<a href=\"http://www.huibo.com/xiaoshou/\">销售</a>类工作经验。 </p> <p> &nbsp; </p> <p> &nbsp; </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5921&job=45041&c=重庆慧果教育科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=5958'>无责任底薪+高提成+住宿</a></dt>
					<dd> 只有一条路不能选择——那就是放弃的路；只有一条路不能拒绝——那就是成...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=5958">我想去</a></u></dd>
