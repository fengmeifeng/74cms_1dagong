...
<html lang="zh-cn">
	...
	<title>销售（底薪+提成+补贴）_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=6164&job=46427&c=重庆卓银科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、开拓市场业务，负责POS机的推广和销售（主要以电话、网络销售、宣传，张贴广告，网上收集客户信息）完成公司的任务指标；<br /> 2、有较好的抗压能力及沟通能力，能吃苦耐劳，敢于挑战高薪； <br /> 3、根据业务要求，定期做客户回访，做好老客户维护和再开发，收集 潜在客户资料；
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=6164&job=46427&c=重庆卓银科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
