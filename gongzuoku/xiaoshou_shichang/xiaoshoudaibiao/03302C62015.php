...
<html lang="zh-cn">
	...
	<title>快消品业务经理_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=2676&job=26620&c=掌合天下（江苏）信息技术有限公司"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <dl>
                        岗位职责：
1、负责市场的开拓、客户的开发、网点的布局及新客户前期进场谈判工作；
2、掌握及时跟进客户提货计划和物流发货状况；
3、负责渠道促销方案的制订
4.吃苦耐劳，有较强的工作责任心和团队协作精神；
5、Office办公软件运用熟练，料制作与Excel数据整理；
6、具有2年以上快消品行业的销售管理经验者优先，对家电行业渠道运作、 市场销售有较强理解者优佳；
工作时间：
8：00-17：00中午有一小时的休息时间（上六休一）
薪资+福利待遇：
薪资+提成+餐补+优秀员工奖+旅游
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=2676&job=26620&c=掌合天下（江苏）信息技术有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
