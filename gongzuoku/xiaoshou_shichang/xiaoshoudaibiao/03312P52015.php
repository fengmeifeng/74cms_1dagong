...
<html lang="zh-cn">
	...
	<meta name="description" content="岗位职责： 1、负责公司业务的市场开发、客户维护和销售管理等工作； 2、负责公司经营产品的宣传、推广和销售，完成销售的任务指标； 3、制定自己的销售计划，并按计划开发新客" />
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=2805&job=26994&c=上海煦子投资管理有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p class=\"\\&quot;MsoNormal\\&quot;\"> 岗位职责：<br /> 1、负责公司业务的市场开发、客户维护和销售管理等工作；<br /> 2、负责公司经营产品的宣传、推广和销售，完成销售的任务指标；&nbsp;<br /> 3、制定自己的销售计划，并按计划开发新客户并维护老客户；&nbsp;<br /> 4、搜集与寻找客户资料，建立客户档案；&nbsp;<br /> 5、做好销售合同的签订、履行与管理等相关工作，以及协调处理各类市场问题； </p> <p class=\"\\&quot;MsoNormal\\&quot;\"> 6、协助销售总监制定销售策略、销售计划，以及量化并完成销售目标；<br /> 任职资格：<br /> 1、大专以上学历,2年以上贵金属、股票、期货，原油等产品相关销售经验及管理经验，有丰富经验者可放宽条件；<br /> 2、从事过销售经理或有丰富客户资源者优先；<br /> 3、具有出色的业务能力，良好的语言表达能力和强烈的进取心；<br /> 4、工作积极主动，踏实勤奋，吃苦耐劳。&nbsp; </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=2805&job=26994&c=上海煦子投资管理有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
