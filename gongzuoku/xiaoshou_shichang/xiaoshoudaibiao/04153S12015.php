...
<html lang="zh-cn">
	...
	<meta name="description" content="岗位职责：1、以电话、路演等营销方式形式面向客户介绍公司相关产品和服务；2、开发、维护新老客户关系；3、协助客户制定理财规划方案；4、收集并反馈客户的建议及意见。 任职资" />
	<title>理财客户/销售专员（主管）_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=3831&job=31460&c=丰汇通财富管理江苏有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        岗位职责： 1、以电话、路演等营销方式形式面向客户介绍公司相关产品和服务； 2、开发、维护新老客户关系； 3、协助客户制定理财规划方案； 4、收集并反馈客户的建议及意见。 任职资格： 1、大专学历，市场营销、电力、人力资源等相关专业； 2、具有良好的沟通协调能力，热爱销售工作； 3、责任心强，踏实勤勉，能承受工作压力，有团队意识。 
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=3831&job=31460&c=丰汇通财富管理江苏有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=3758'>社区推广专员</a></dt>
					<dd>工作职责：  1.发展与构建客户网络，与客户密切沟通。  2.及时跟进潜在客户，...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3758">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=3756'>高薪销售顾问</a></dt>
					<dd> 思迈尔寄语：你可以没有任何工作经验，我们有岗前培训；只要你是有上进心...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=3756">我想去</a></u></dd>
