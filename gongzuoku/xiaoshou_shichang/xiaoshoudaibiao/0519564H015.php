...
<html lang="zh-cn">
	...
	<title>诚聘高薪双休业务经理_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>招聘人数：</span>150人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2015-05-22</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5647&job=41521&c=重庆迅代投资管理有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p> 1.有上进心，心态好 </p> <p> 2.有团队精神 </p> <p> 3.认真踏实 </p> <p> 上班时间：早9晚6&nbsp;&nbsp;&nbsp; 周末双休&nbsp;&nbsp;&nbsp; </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5647&job=41521&c=重庆迅代投资管理有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
