        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>安徽学习力文化传播有限公司</li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=2309&job=24802&c=安徽学习力文化传播有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        要求会网络搜索引擎、博客、论坛、播客、图片、博客、专栏等营销，主要会QQ和微信营销，会SEO优化者优先。
     薪水 =工资2000+1%提成+2%的奖金

                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=2309&job=24802&c=安徽学习力文化传播有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
