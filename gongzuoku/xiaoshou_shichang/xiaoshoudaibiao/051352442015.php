...
<html lang="zh-cn">
	...
	<title>合肥经开区明珠广场高薪工作急聘_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5244&job=39224&c=合肥同聚福商贸有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p> 岗位职责: </p> <p> 1、通过电话和网络开发意向客户，与目标客户建立良好的关系； </p> <p> 2、完成销售团队分配的销售任务，为现有客户和潜在客户提供金融理财服务的相关信息； </p> <p> 3、做好客户的日常沟通和关系维护工作，提高客户满意度。 </p> <p> 4、有担当，有责任心，喜欢与人沟通，互勉互助，敢于挑战高薪； </p> <p> 5、能活跃气氛，带动团队积极性者优先。 </p> <p> 任职资格: </p> <p> 1、高中及以上学历，男女不限，18—30周岁，会简单电脑操作；<br /> 2、对销售工作有较高的热情,语言表达清晰流畅； </p> <p> 3、具备较强的学习能力和优秀的沟通能力/有严格的执行力； </p> <p> 4、性格坚韧，思维敏捷，具备良好的应变能力和承压能力； </p> <p> 5、有强烈的事业心、责任心和积极的工作态度，有证券、房产，相关金融行业销售经验者优先。 </p> <p> 有意者可电话咨询15395112800 </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5244&job=39224&c=合肥同聚福商贸有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
