...
<html lang="zh-cn">
	...
	<title>腾讯产品推广专员_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=41020&action=archives&channelid=81">重庆启善益融信息技术有限公司</a></li>
                        ...
                        <li ><span>截止时间：</span>2015-05-16</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5534&job=41020&c=重庆启善益融信息技术有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        负责腾讯乐刷支付产品及微信摇一摇周边设备的宣传和推广工作，工作时间早九晚五，周末双休及其他福利待遇。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5534&job=41020&c=重庆启善益融信息技术有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
