...
<html lang="zh-cn">
	...
	<meta name="description" content="1、在上级的领导和监督下定期完成量化的工作要求，并能独立处理和解决所负责的任务； 2、管理客户关系，完成销售任务； 3、了解和发掘客户需求及购买愿望，介绍自己产品的优点" />
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5002&job=37363&c=重庆元辰信胜科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <!--StartFragment --> <div> <br /> 1、在上级的领导和监督下定期完成量化的工作要求，并能独立处理和解决所负责的任务；&nbsp;<br /> 2、管理客户关系，完成销售任务；&nbsp;<br /> 3、了解和发掘客户需求及购买愿望，介绍自己产品的优点和特色；&nbsp;<br /> 4、对客户提供专业的咨询；&nbsp;<br /> 5、收集潜在客户资料；&nbsp;<br /> 6、收取应收帐款。<br /> </div>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5002&job=37363&c=重庆元辰信胜科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
