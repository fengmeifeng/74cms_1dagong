...
<html lang="zh-cn">
	...
	<title>电话销售，销售代表（客户专员）_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>电话销售，销售代表（客户专员）</h1>
                </div>
                <div class="h1_box">发布时间： 2015年03月30日</div>
                <div class="over">
                    <ul class="a_box">
                        <li ><span>工资：</span><strong>5000-8000</strong></font><span>元/月</span></li>
                        <li ><span>公司：</span><a href="/home/index.php?uid=25573&action=archives&channelid=81">上海隋鼎文化传播有限公司</a></li>
                        ...
                        <li ><span>截止时间：</span>2015-05-01</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=2554&job=25573&c=上海隋鼎文化传播有限公司"> 投递简历 </a>
...
1、負責産品的市場渠道開拓與銷售工作，執行並完成公司産品年度銷售計劃。

2、根據公司市場營銷戰略，提升銷售價值，控製成本，擴大産品在所負責區域的銷售，積極完成銷售量指標，擴大産品市場佔有率；

3、與客戶保持良好溝通，實時把握客戶需求。為客戶提供主動、熱情、滿意、週到的服務

4、根據公司産品、價格及市場策略，獨立處置詢盤、報價、合同條款的協商及合同簽訂等事宜。在執行合同過程中，協調並監督公司各職能部門操作。
...
4、有較強的事業心。
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=2554&job=25573&c=上海隋鼎文化传播有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
