...
<html lang="zh-cn">
	...
	<title>FTC集团招渠道销售_壹打工网-让工作来找你</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=2026&job=24423&c=FTC GROUP LIMITED"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        岗位职责：通过QQ、电话方式 发展客户、维护​‌‌客户
任职资格：有梦想、有理想、想成功、善于团队合作
工作时间：早9晚6 做五休二 国家规定节假日休息
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=2026&job=24423&c=FTC GROUP LIMITED" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
