...
<html lang="zh-cn">
	...
	<title>招聘机械销售_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=29955&action=archives&channelid=81">萨曼机械（上海）有限公司</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=3537&job=29955&c=萨曼机械（上海）有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <p class=\"MsoNormal\"> 岗位职责： </p> <p class=\"MsoNormal\"> 1<span>、负责公司产品的销售及推广；</span> </p> <p class=\"MsoNormal\"> 2<span>、根据市场营销计划，完成部门销售指标；</span> </p> <p class=\"MsoNormal\"> 3<span>、开拓新市场</span><span>,</span><span>发展新客户</span><span>,</span><span>增加产品销售范围；</span> </p> <p class=\"MsoNormal\"> 4<span>、负责辖区市场信息的收集及分析；</span> </p> <p class=\"MsoNormal\"> 5<span>、负责销售区域内销售活动的执行，完成销售任务；</span> </p> <p class=\"MsoNormal\"> 6<span>、管理维护客户关系以及长期合作计划。</span> </p>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=3537&job=29955&c=萨曼机械（上海）有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
