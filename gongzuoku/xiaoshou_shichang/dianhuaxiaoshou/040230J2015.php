...
<html lang="zh-cn">
	...
	<meta name="description" content="1、依托公司和自有资‌‌源‌‌，通过‌‌各类有效渠道，接触并筛选对投资理财有需求的有效客户； 2、邀请客户参与公司组织的理财沙龙和各种活动，提升客户转化率； 3、通过对客" />
	<title>诚实招聘精英_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>银城财富投资管理（上海）有限公司</li>
                        ...
                        <li ><span>截止时间：</span>2015-07-02</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=3074&job=26751&c=银城财富投资管理（上海）有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、依托公司和自有资‌‌源‌‌，通过‌‌各类有效渠道，接触并筛选对投资理财有需求的有效客户；<br /> 2、邀请客户参与公司组织的理财沙龙和各种活动，提升客户转化率；<br /> 3、通过对客户的的综合理财需求分析，向客户推荐合适的基金、信托、私募等投资产品，并协助客户购买；<br /> 4、通过持续跟进与服务，为客户不断提供专业的理财咨询与服务。<br /> 任职资格：1、有销售经验或渠道合作经验优先；<br /> 2、银行、证券、基金信托、保险、第三方理财公司、房地产、汽车销售、高端培训、奢侈品行业经验者优先；<br /> 3、有一定投资客户资源；<br /> 工作时间：<br /> 双休，09:00-17:30，享受法定假日及年假
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=3074&job=26751&c=银城财富投资管理（上海）有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=2988'>上市公司聘车险专员五险</a></dt>
					<dd> 任职要求   二、岗位要求： 1、性别年龄学历不限 2、最重要的：要有赚钱欲望...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=2988">我想去</a></u></dd>
