        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>截止时间：</span>2016-05-27</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=6044&job=46129&c=徐州今天广告文化传播有限公司重庆分公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">岗位职责：</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">1、了解客户服务需求信息，进行有效跟踪，做好售前、售后指导、服务跟进等售后服务</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">工作；<span class=\"Apple-converted-space\">&nbsp;</span></span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">2、熟练运用公司产品，解答客户提问并落实问题；<span class=\"Apple-converted-space\">&nbsp;</span></span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">3、与相关部门紧密配合，协调沟通；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">4、维护客户关系，并开发新客户，具备处理问题、安排进展、跟进进程、沟通及疑难问题服务的意识跟能力，最大限度的提高客户满意度。遇到不能解决的问题按流程提交相关人员或主管处理，并跟踪进展直至解决；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">5、具备一定的销售能力，针对公司现有的客户进行营销，让客户接受更为广泛的产品，达到最好的效果。</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">任职资格：</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">1、1年以上销售或客服工作经验优先录用；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">2、具备敏锐的商业意识，较强的应变能力、口头表达与沟通能力；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">3、有较强的推广和维护协调客户的能力，熟悉客户服务流程；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">4、具备较强的学习能力，可快速掌握专业知识，及时开展工作；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">5、熟练运用office及良好的文档写作能力；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">6、工作严谨，计划性强，善于分析思考问题，有责任心；</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">7、勤奋踏实，良好的服务意识与团队合作精神。<span class=\"Apple-converted-space\">&nbsp;</span></span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">工作时间：周一至周六，8：30-17：30（单休）</span><br /> <span style=\"color:#4B4B4B;background-color:#FFFFFF;\">待遇：底薪+全勤+工龄工资+绩效奖金+年终奖（能力决定收入）</span>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=6044&job=46129&c=徐州今天广告文化传播有限公司重庆分公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
