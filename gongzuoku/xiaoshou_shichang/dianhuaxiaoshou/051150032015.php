...
<html lang="zh-cn">
	...
	<meta name="description" content="工作内容：通过电话为用户提供咨询、受理服务及产品推介工作。 岗位要求： 1、年龄18—28岁，性别女，普通话标准声音甜美，语言表达能力强 2、能熟练使用电脑； 3、组织纪律性较" />
	<title>电话营销专员_壹打工网-让工作来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=37363&action=archives&channelid=81">重庆元辰信胜科技有限公司</a></li>
                        ...
                        <li ><span>截止时间：</span>2016-05-11</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=5003&job=37363&c=重庆元辰信胜科技有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <!--StartFragment --> <div> 工作内容：通过电话为用户提供咨询、受理服务及产品推介工作。<br /> 岗位要求：<br /> 1、年龄18—28岁，性别女，普通话标准声音甜美，语言表达能力强<br /> 2、能熟练使用电脑；<br /> 3、组织纪律性较强，有进取精神和团队合作意识<br /> 4、具有较强的工作责任心和积极的工作状态<br /> 5、具备较强的学习能力和沟通能力，热爱客户服务和销售工作<br /> 6、有敏锐的市场洞察力和应变能力，有较强的责任心，有相关服务和营销经验者优先<br /> </div>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=5003&job=37363&c=重庆元辰信胜科技有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
