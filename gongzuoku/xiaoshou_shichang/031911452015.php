...
<html lang="zh-cn">
	...
	<title>储备专卖店经理_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1145&job=21129&c=苏州骏丰频谱有限责任公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        性格外向开朗，善于沟通，敢于挑战高薪，对营销管理工作感兴趣，担任学生干部者优先，面试合格者可输送到北京系统培训三个月，负责连锁期满后可任命为苏州公司专卖店经理
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1145&job=21129&c=苏州骏丰频谱有限责任公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
