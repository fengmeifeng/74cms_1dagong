...
<html lang="zh-cn">
	...
	<title>客服主管/助理/普工/出图员_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1162&job=20960&c=合肥市烈焰文化传播有限公司"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        要求具有团队精神、客户开发能力、善于与人沟通、吃苦耐劳，有两年及以上相关岗位工作经验,服从公司工作安排，主要工作为手工拼接喷绘画面及安装商场超市室内广告灯箱等
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="#">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1162&job=20960&c=合肥市烈焰文化传播有限公司" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
