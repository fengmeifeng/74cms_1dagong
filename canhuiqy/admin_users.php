...
if($act == 'list')
{
	...
	$smarty->display('users_ch/admin_users_list.htm');
}
elseif($act == 'add_users')
{
	...
	$smarty->display('users_ch/admin_users_add.htm');
}
elseif($act == 'add_users_save')
{
	...
	$setsqlarr['pwd']=md5($_POST['password']);	
	//echo $setsqlarr['pwd'];exit;
	//----ffff
...
elseif($act == 'edit_users')
{
	...
	$smarty->assign('admin_purview',$_SESSION['admin_purview']);
	$smarty->display('users_ch/admin_users_edit.htm');
	}
	else
	{
	adminmsg("参数错误！",1);
...
elseif($act == 'edit_users_pwd')
{
	...
	$smarty->assign('account',$account);
	$smarty->assign('admin_purview',$_SESSION['admin_purview']);
	$smarty->display('users_ch/admin_users_edit_pwd.htm');
	}
	else
	{
	adminmsg("参数错误！",1);
...
elseif($act == 'edit_users_pwd_save')
{
	...
	if ($account['purview']=="all" && $_SESSION['admin_purview']=="all")
	{
				...
				$md5_pwd=md5($_POST['old_password']);
				//----fff
...
elseif($act == 'loglist')
{
	...
	$smarty->display('users_ch/admin_users_log.htm');
}
elseif($act == 'users_set')
{
	...
	$smarty->display('users_ch/admin_users_set.htm');
}
