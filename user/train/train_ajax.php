...
if($act=="user_email"){
	$tpl='../../templates/'.$_CFG['template_dir']."member_train/ajax_authenticate_email_box.htm";
...
elseif($act=="user_mobile"){
	$tpl='../../templates/'.$_CFG['template_dir']."member_train/ajax_authenticate_mobile_box.htm";
	$contents=file_get_contents($tpl);
...
elseif($act=="old_mobile"){
	$tpl='../../templates/'.$_CFG['template_dir']."member_train/ajax_authenticate_old_mobile_box.htm";
	$contents=file_get_contents($tpl);
	$_SESSION['send_mobile_key']=mt_rand(100000, 999999);
...
elseif($act=="edit_mobile"){
	$tpl='../../templates/'.$_CFG['template_dir']."member_train/ajax_authenticate_edit_mobile_box.htm";
	$contents=file_get_contents($tpl);
	$_SESSION['send_mobile_key']=mt_rand(100000, 999999);
	$contents=str_replace('{#$send_mobile_key#}',$_SESSION['send_mobile_key'],$contents);
	exit($contents);
