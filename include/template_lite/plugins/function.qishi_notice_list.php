...
if ($_CFG['subsite']=="1" && $_CFG['subsite_filter_notice']=="1" && intval($_CFG['subsite_id'])>0)
{
...
$row['url'] =$row['is_url']<>"http://"?$row['is_url']:url_rewrite($aset['showname'],array('id'=>$row['id']),true,$row['subsite_id']);
