...
function tpl_function_qishi_jobs_show($params, &$smarty)
{
	...
	else
	{
			...
			//----ff
			$val['wage_cn']=$val['wage_cn']=="面议"?'面议':$val['wage_cn']."元/月";
			
			$description=$val['contents']==""?'招聘网':$val['contents'];
			$val['description'] =cut_str(DeleteHtml($description),122,0,""); 
			//echo $val['description'];exit;
			//---ff
